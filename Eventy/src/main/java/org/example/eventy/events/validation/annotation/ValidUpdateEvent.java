...
import org.example.eventy.events.validation.validator.UpdateEventValidator;
...
@Constraint(validatedBy = UpdateEventValidator.class)
public @interface ValidUpdateEvent {
    String message() default "Invalid update event"; // default message (you can override this)
