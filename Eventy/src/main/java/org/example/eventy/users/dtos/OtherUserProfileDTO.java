...
public class OtherUserProfileDTO {
    ...
    private List<EventCardDTO> myEvents;
    private List<SolutionCardDTO> mySolutions;

    public OtherUserProfileDTO() {

    }

    public OtherUserProfileDTO(User user, UserType userType, List<Event> myEvents, List<Solution> mySolutions) {
        this.id = user.getId();
        ...
        this.myEvents = myEvents.stream().map(EventCardDTO::new).collect(Collectors.toList());
        this.mySolutions = mySolutions.stream().map(SolutionCardDTO::new).collect(Collectors.toList());
    }

    public OtherUserProfileDTO(Long id, List<String> profilePictures, UserType userType, String email, String firstName, String lastName, String name, String description, String address, String phoneNumber) {
        this.id = id;
    ...
    public void setMyEvents(List<EventCardDTO> myEvents) {
        this.myEvents = myEvents;
    }

    public List<SolutionCardDTO> getMySolutions() {
        return mySolutions;
    }

    public void setMySolutions(List<SolutionCardDTO> mySolutions) {
        this.mySolutions = mySolutions;
    }
}
