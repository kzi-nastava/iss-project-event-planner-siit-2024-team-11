...
public class ProductDTO {
    ...
    public ProductDTO(String name, String description, double price, double discount, List<EventTypeDTO> relatedEventTypes, byte[][] images, boolean visibility, boolean availability) {
        this.name = name;
